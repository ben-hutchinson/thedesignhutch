...
export function ProcessSection({
  ...
  return (
    ...
    >
      ...
      <ol className="relative mt-8 grid gap-0 border-y border-[#181a17]/35 md:grid-cols-4">
        <span
          aria-hidden
        ...
        {processSteps.map((step, index) => (
          <li
            key={step.step}
            className={`relative min-h-[24rem] border-b border-[#181a17]/30 px-6 py-5 last:border-b-0 md:border-b-0 md:border-r md:last:border-r-0 ${index === 1 ? "text-accent-blue" : ""}`}
          >
            ...
            <div className="relative mt-5 h-32 p-2">
  ...
  return (
    ...
    >
      <path
        d={
          index === 0
            ? "M18 76 92 20l79 56M33 66v22m123-21v21M60 88V58h65v30M14 51l78-42 84 42M24 80c25-18 48-20 69-5 20 13 43 12 74-7"
            : index === 1
              ? "M16 84 92 20l81 64M28 76h137M52 60h86M72 43h45M48 87V63m91 24V62M92 20v67M20 71h145M34 54h116M52 37h81"
              : index === 2
                ? "M18 18h154v70H18zM18 31h154M32 45h126v29H32z"
                : "M18 50h40m18 0h34m18 0h38M58 50a7 7 0 1 0 14 0 7 7 0 1 0-14 0m52 0a7 7 0 1 0 14 0 7 7 0 1 0-14 0m42 0a7 7 0 1 0 14 0 7 7 0 1 0-14 0"
        }
        strokeWidth="1.4"
      />
    </svg>
